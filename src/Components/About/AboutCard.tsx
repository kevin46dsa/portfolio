    ...
    <Card>
      <Card.Body>
        ...
        <p style={{ textAlign: "justify" }}>
          ...
          including photography, basketball, and exploring the great outdoors. I
          find inspiration in the beauty of nature and the thrill of adventure.
          When I'm not tinkering with code or shooting hoops, I'm often found
          exploring the world of cars, delving into their inner workings and
          design features. My diverse range of interests and insatiable
